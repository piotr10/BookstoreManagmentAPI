...
namespace BookstoreManagement.Persistance.Migrations
{
    ...
    [Migration("20220829234556_changeGenreProperty")]
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Author.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5553),
                            CreatedBy = "",
                            InactivatedBy = "",
                            ModifiedBy = "",
                            StatusId = 1
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Author.AuthorBiography", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorId = 1,
                            Country = "Poland",
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5790),
                            CreatedBy = "",
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Author.AuthorContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorId = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5869),
                            CreatedBy = "",
                            InactivatedBy = "",
                            ModifiedBy = "",
                            Name = "No contacts",
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Book.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5883),
                            CreatedBy = "",
                            InactivatedBy = "",
                            ModifiedBy = "",
                            StatusId = 1
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Customer.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5928),
                            CreatedBy = "",
                            InactivatedBy = "",
                            ModifiedBy = "",
                            StatusId = 1
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5930),
                            CreatedBy = "",
                            InactivatedBy = "",
                            ModifiedBy = "",
                            StatusId = 1
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Customer.CustomerAddress", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Warsaw",
                            Country = "Poland",
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5973),
                            CreatedBy = "",
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Customer.CustomerDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(5953),
                            CreatedBy = "",
            ...
            modelBuilder.Entity("BookstoreManagement.Domain.Entities.Order.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            Created = new DateTime(2022, 8, 30, 1, 45, 56, 16, DateTimeKind.Local).AddTicks(6010),
                            CreatedBy = "",
                            CustomerId = 1,
